...
public class FolderManager {
     ...
     * 应用程序在SD卡上的主目录名称
     */
    private final static String APP_FOLDER_NAME = "powerful";
    /**
     * 存放图片目录名
     */
    ...
    public static File getPhotoFolder() {
        ...
        if (appFolder != null) {
            ...
            File photoFolder = new File(appFolder, IMAGE_FOLDER_NAME);
    ...
    public static File getDownLoadFolder() {
        ...
        if (appFolder != null) {
            ...
            File downloadFolder = new File(appFolder, DOWNLOAD_PATH);
